...
export type SiteSettings={copyright_text:string;facebook_url:string|null;youtube_url:string|null;instagram_url:string|null;linkedin_url:string|null;x_url:string|null};
...
const defaultSettings:SiteSettings={copyright_text:'© 2026 JnU News. All rights reserved.',facebook_url:null,youtube_url:null,instagram_url:null,linkedin_url:null,x_url:null};
