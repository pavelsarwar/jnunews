import type {Metadata} from "next"; import {Anek_Bangla} from "next/font/google"; import "./globals.css"; import "./public-shared.css"; import "./rich-editor.css"; import "./admin-responsive.css";
